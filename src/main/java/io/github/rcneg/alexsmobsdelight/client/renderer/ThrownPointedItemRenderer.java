...
@OnlyIn(Dist.CLIENT)
public class ThrownPointedItemRenderer<T extends Entity & ItemSupplier> extends EntityRenderer<T> {
    private final ItemRenderer itemRenderer;
    private final float scale;

    public ThrownPointedItemRenderer(EntityRendererProvider.Context p_174416_, float p_174417_) {
        super(p_174416_);
        this.itemRenderer = p_174416_.getItemRenderer();
        this.scale = p_174417_;
    }

    public ThrownPointedItemRenderer(EntityRendererProvider.Context p_174414_) {
        this(p_174414_, 1.0F);
    }
