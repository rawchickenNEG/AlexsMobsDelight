...
public class StuffedGrilledAnacondaBlock extends FeastBlock {
    ...
    public StuffedGrilledAnacondaBlock(Properties properties, Supplier<Item> servingItem, boolean hasLeftovers) {
