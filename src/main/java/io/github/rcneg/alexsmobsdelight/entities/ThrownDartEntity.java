...
public class ThrownDartEntity extends AbstractArrow implements ItemSupplier {
    ...
    public ThrownDartEntity(EntityType<? extends ThrownDartEntity> p_37561_, Level p_37562_) {
